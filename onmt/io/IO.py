...
from onmt.io.TextDataset import MyTextDataset as TextDataset
...
def build_dataset(fields, data_type, src_path, ans_path, tgt_path, src_dir=None,
                  src_seq_length=0, ans_seq_length=0, tgt_seq_length=0,
                  src_seq_length_trunc=0, ans_seq_length_trunc=0, tgt_seq_length_trunc=0,
    ...
    src_examples_iter, num_src_feats = \
        _make_examples_nfeats_tpl(data_type, "src", src_path, src_dir,
                                  src_seq_length_trunc, sample_rate,
                                  window_size, window_stride,
                                  window, normalize_audio)
    # add for ans
    ans_examples_iter, num_ans_feats = \
        _make_examples_nfeats_tpl(data_type, "ans", ans_path, src_dir,
    ...
    if data_type == 'text':
        # add for ans
        dataset = TextDataset(fields, src_examples_iter, ans_examples_iter, tgt_examples_iter,
                              num_src_feats, num_ans_feats, num_tgt_feats,
...
def build_vocab(train_dataset_files, fields, data_type, share_vocab,
    ...
    if data_type == 'text':
        ...
        # add for ans
        fields["ans"].vocab = fields["src"].vocab
        print(" * ans vocab size: %d." % len(fields["ans"].vocab))
        ...
        for j in range(dataset.n_src_feats):
            ...
            print(" * %s vocab size: %d." % (key, len(fields[key].vocab)))
            # add for ans
            ans_key = "ans_feat_" + str(j)
            fields[ans_key].vocab = fields[key].vocab
            print(" * %s vocab size: %d." % (ans_key, len(fields[ans_key].vocab)))
...
def _make_examples_nfeats_tpl(data_type, side, src_path, src_dir,
                              src_seq_length_trunc, sample_rate,
                              window_size, window_stride,
                              window, normalize_audio):
    """
