...
def build_save_text_dataset_in_shards(src_corpus, ans_corpus, tgt_corpus, fields,
                                      corpus_type, opt):
    '''
    ...
    # add for ans
    ans_iter = onmt.io.ShardedTextCorpusIterator(
    ...
    while not src_iter.hit_end():
        index += 1
        dataset = onmt.io.MyTextDataset(
                fields, src_iter, ans_iter, tgt_iter,
                src_iter.num_feats, ans_iter.num_feats, tgt_iter.num_feats,
...
def build_save_dataset(corpus_type, fields, opt):
    ...
    if opt.data_type == 'text':
        return build_save_text_dataset_in_shards(
                src_corpus, ans_corpus, tgt_corpus, fields,
                corpus_type, opt)
