...
def preprocess_opts(parser):
    ...
    group.add_argument('-train_ans', required=True,
                       help="Path to the text training answer data")
    ...
    group.add_argument('-valid_ans', required=True,
                       help="Path to the text validation answer data")
    ...
    # add for ans
    group.add_argument('-ans_seq_length', type=int, default=20,
                       help="Maximum answer sequence length")
    # add for ans
    group.add_argument('-ans_seq_length_trunc', type=int, default=0,
                       help="Truncate ans sequence length.")
...
def translate_opts(parser):
    ...
    group.add_argument('-ans', required=True,
                       help="""Answer sequence to decode (one line per
                           sequence)""")
    group.add_argument('-src_dir',   default="",
                       help='Source directory for image or audio files')
